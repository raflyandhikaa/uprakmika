                ...
                <div class="form-container">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="username" id="username" class="form-control" value="<?php echo $edit_username; ?>"  autocomplete="off" required>
                        </div>
                        <div class="mb-3">
                            <label for="password" class="form-label">Password:</label>
                            <input type="password" name="password" id="password" class="form-control" value="<?php echo $edit_password; ?>" required>
                        </div>
                        <div class="mb-3">
